...
namespace digi_project3.Database1DataSetTableAdapters {
    ...
    public partial class descriptionTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "DELETE FROM description\r\nWHERE (Id = @Id)";
            ...
            this._commandCollection[2].CommandText = "SELECT Id, image, ingridients, name, text FROM description WHERE (name LIKE @name" +
                " + \'%\')";
        ...
        public virtual int Update(string text, string ingridients, string name, int Id) {
            if ((text == null)) {
